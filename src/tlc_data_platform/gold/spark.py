...
from tlc_data_platform.core.settings import LayerSparkConfig


class GoldSparkProvider:
    """Creates a resource-bounded Gold session with host-visible spill storage."""

    def __init__(self, config: LayerSparkConfig) -> None:
        self._config = config
    ...
    def get(self) -> Any:
        if self._session is None:
            ...
            self._session = (
                ...
                .config("spark.sql.adaptive.advisoryPartitionSizeInBytes", str(64 * 1024**2))
